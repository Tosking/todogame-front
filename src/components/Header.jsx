...
import { useLogOutMutation } from "store/slice/auth/authSlice";
      ...
      <div className="header__inner container">
        {burger ? (
          ...
          <Link to={to ?? "/main"}>
            ...
            >
              <path
                d="M0.939339 15.9393C0.353552 16.5251 0.353552 17.4749 0.939339 18.0607L10.4853 
              ...
              6.3934C12.0208 5.80761 11.0711 5.80761 10.4853 6.3934L0.939339 15.9393ZM32 15.5L2 15.5V18.5L32 18.5V15.5Z"
                fill="white"
              />
            </svg>
          </Link>
